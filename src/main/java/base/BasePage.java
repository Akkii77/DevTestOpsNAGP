...
public class BasePage {
	...
	/*
	 * public HashMap<String, String> unionOfTwoMap(HashMap<String, String> map1,
	 * HashMap<String, String> map2) throws ParseException { map2.forEach((key,
	 * value) -> map1.merge(key, value, (v1, v2) -> v1.equalsIgnoreCase(v2) ? v1 :
	 * v1 + "," + v2)); Log.info(map1); return map1; }
	 */
